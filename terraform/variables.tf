...
variable "pipeline_name" {
  ...
  type        = string
  default     = "devsecops-pipeline-daniel"
}
...
variable "key_pair" {
  ...
  default     = "key" //Substitua por sua chave SSH
}
variable "key_pair_ssh" {
  description = "Nome do par de chaves SSH para a EC2"
  default     = "key.pem" //Substitua por sua chave SSH
}
...
variable "github_owner" {
  ...
  default     = "DanielMelo1" //Substitua por seu usuario github
}
